  ...
  <!--        </el-form-item>-->
      ...
      <el-dialog
        ...
        <el-form :data="formData" :model="editForm" :rules="editFormRules" ref="editForm" label-width="90px"
          ...
          <el-form-item label="与相邻轮次比较垂直位移量(mm)" prop="adjacent_vertical_displacement">
      ...
      <el-dialog  width="80%" :visible.sync="curveWindow">
        <AdjacentVerticalChart :key="chartKey"></AdjacentVerticalChart>
      </el-dialog>
    </div>
</template>

<script>
  import AdjacentVerticalChart from "@/components/AdjacentVertical/AdjacentVerticalChart";
  import {GetList, AddList, DeleteList, UpdateList} from "@/api/AdjacentVertical/AdjacentVertical";
  ...
  export default {
    ...
    data() {
      return {
        ...
        editForm: {
          ...
          abscissaY:'',
          point_name:'',
          adjacent_vertical_displacement:'',
        },
        queryInfo: {
          query:'',
          // 当前每页显示多少条数据
    ...
    methods: {
      ...
      getList() {
        ...
        this.$store.dispatch('changeAdjacentVerticalTime',StartEndTime);
        GetList({
