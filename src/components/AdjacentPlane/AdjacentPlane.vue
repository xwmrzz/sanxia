  ...
  <!--        </el-form-item>-->
      ...
      <el-dialog
        ...
        <el-form :data="formData" :model="editForm" :rules="editFormRules" ref="editForm" label-width="90px"
          ...
          <el-form-item label="与相邻轮次比较平面位移量(mm)" prop="adjacent_plane_displacement">
      ...
      <el-dialog  width="80%" :visible.sync="curveWindow">
        <AdjacentPlaneChart :key="chartKey"></AdjacentPlaneChart>
      </el-dialog>
    </div>
</template>

<script>
  import AdjacentPlaneChart from "@/components/AdjacentPlane/AdjacentPlaneChart";
  import {GetList, AddList, DeleteList, UpdateList} from "@/api/AdjacentPlane/AdjacentPlane";
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        this.$store.dispatch('changeAdjacentPlaneTime',StartEndTime);
        GetList({
