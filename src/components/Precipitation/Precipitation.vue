  ...
  <!--        </el-form-item>-->
      ...
      <el-dialog
        ...
        <el-form :data="formData" :model="editForm" :rules="editFormRules" ref="editForm" label-width="90px"
          ...
          <el-form-item label="降雨量(mm)" prop="precipitation">
      ...
      <el-dialog  width="80%" :visible.sync="curveWindow">
        <PrecipitationChart2 :key="chartKey"></PrecipitationChart2>
      </el-dialog>
    </div>
</template>

<script>
  import PrecipitationChart2 from "@/components/Precipitation/PrecipitationChart2";
  import {GetList, AddList, DeleteList, UpdateList} from "@/api/Precipitation/Precipitation";
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        this.$store.dispatch('changePrecipitationTime',StartEndTime);
        GetList({
