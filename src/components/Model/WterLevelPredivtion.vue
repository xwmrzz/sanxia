...
import {chartWater, listWater} from "@/api/Model/WaterLevel";
  ...
  data() {
    return {
      ...
      StorageCapacity: {
        ...
        legend: {
          data: ['实际水位','七天预测水位','十四天预测水位','二十一天预测水位']
        },
        // 下载图片
        // toolbox: {
        //   feature: {
    ...
    getWaterLvList() {
      chartWater().then(res => {
        ...
        data.forEach(i => {
          ...
          y3.push(i.twentyoneModelPrediction)
        })
