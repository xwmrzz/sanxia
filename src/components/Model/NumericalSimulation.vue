  ...
  <div class="numerical">
    ...
    <div class="Top">
      <div class="a" v-viewer >
        <dv-border-box-11 title="单因素降雨">
        <img src="../../../public/static/单因素降雨.gif" height="77%" width="92%" style="margin-top: 7vh"/>
        </dv-border-box-11>
      </div>
      <div class="b" v-viewer>
        <dv-border-box-11 title="降雨+库水位上升(145-175)">
          <img src="../../../public/static/库水位上升（145-175）.gif" height="77%" width="92%" style="margin-top: 7vh"/>
        </dv-border-box-11>
      </div>

      <div class="b" v-viewer>
        <dv-border-box-11 title="降雨+库水位上升(145-175)">
          <img src="../../../public/static/库水位下降（175-145）.gif" height="77%" width="92%" style="margin-top: 7vh"/>
        </dv-border-box-11>
      </div>
    </div>
    <div class="Bottom">
      <div class="c" v-viewer>
        <dv-border-box-11 title="库水位上升(145-175)">
          <img src="../../../public/static/库水位上升（145-175）.gif" height="77%" width="92%" style="margin-top: 7vh"/>
        </dv-border-box-11>
      </div>
      <div class="d" v-viewer>
        <dv-border-box-11 title="库水位下降(175-145)">
          <img src="../../../public/static/库水位下降（175-145）.gif" height="77%" width="92%" style="margin-top: 7vh"/>
        </dv-border-box-11>
      </div>
      <div class="button">
