  ...
  <!--        </el-form-item>-->
      ...
      <el-dialog
        ...
        <el-form :data="formData" :model="editForm" :rules="editFormRules" ref="editForm" label-width="90px"
          ...
          <el-form-item label="与首轮比较δy(mm)" prop="δy_first">
      ...
      <el-dialog  width="80%" :visible.sync="curveWindow">
        <yFirstChart :key="chartKey"></yFirstChart>
      </el-dialog>
    </div>
</template>

<script>
  import yFirstChart from "@/components/δyFirst/yFirstChart";
  import {GetList, AddList, DeleteList, UpdateList} from "@/api/δyFirst/δyFirst";
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        this.$store.dispatch('changeδyFirstTime',StartEndTime);
        GetList({
