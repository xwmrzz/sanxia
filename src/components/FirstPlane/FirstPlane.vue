  ...
  <!--        </el-form-item>-->
      ...
      <el-dialog
        ...
        <el-form :data="formData" :model="editForm" :rules="editFormRules" ref="editForm" label-width="90px"
          ...
          <el-form-item label="与首轮比较平面位移量(mm)" prop="first_plane_displacement">
      ...
      <el-dialog  width="80%" :visible.sync="curveWindow">
        <FirstPlaneChart :key="chartKey"></FirstPlaneChart>
      </el-dialog>
    </div>
</template>

<script>
  import FirstPlaneChart from "@/components/FirstPlane/FirstPlaneChart";
  import {GetList, AddList, DeleteList, UpdateList} from "@/api/FirstPlane/FirstPlane";
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        this.$store.dispatch('changeFirstPlaneTime',StartEndTime);
        GetList({
