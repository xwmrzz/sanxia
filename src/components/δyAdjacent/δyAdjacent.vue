  ...
  <!--        </el-form-item>-->
      ...
      <el-dialog
        ...
        <el-form :data="formData" :model="editForm" :rules="editFormRules" ref="editForm" label-width="90px"
          ...
          <el-form-item label="与相邻轮次比较δy(mm)" prop="δy_adjacent">
      ...
      <el-dialog  width="80%" :visible.sync="curveWindow">
        <yAdjacentChart :key="chartKey"></yAdjacentChart>
      </el-dialog>
    </div>
</template>

<script>
  import yAdjacentChart from "@/components/δyAdjacent/yAdjacentChart";
  import {GetList, AddList, DeleteList, UpdateList} from "@/api/δyAdjacent/δyAdjacent";
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        this.$store.dispatch('changeδyAdjacentTime',StartEndTime);
        GetList({
