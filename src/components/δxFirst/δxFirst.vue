  ...
  <!--        </el-form-item>-->
      ...
      <el-dialog
        ...
        <el-form :data="formData" :model="editForm" :rules="editFormRules" ref="editForm" label-width="90px"
          ...
          <el-form-item label="与首轮比较δx(mm)" prop="δx_first">
      ...
      <el-dialog  width="80%" :visible.sync="curveWindow">
        <xFirstChart :key="chartKey"></xFirstChart>
      </el-dialog>
    </div>
</template>

<script>
  import xFirstChart from "@/components/δxFirst/xFirstChart";
  import {GetList, AddList, DeleteList, UpdateList} from "@/api/δxFirst/δxFirst";
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        this.$store.dispatch('changeδxFirstTime',StartEndTime);
        GetList({
