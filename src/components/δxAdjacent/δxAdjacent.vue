  ...
  <!--        </el-form-item>-->
      ...
      <el-dialog
        ...
        <el-form :data="formData" :model="editForm" :rules="editFormRules" ref="editForm" label-width="90px"
          ...
          <el-form-item label="与相邻轮次比较δx(mm)" prop="δx_adjacent">
      ...
      <el-dialog  width="80%" :visible.sync="curveWindow">
        <xAdjacentChart :key="chartKey"></xAdjacentChart>
      </el-dialog>
    </div>
</template>

<script>
  import xAdjacentChart from "@/components/δxAdjacent/xAdjacentChart";
  import {GetList, AddList, DeleteList, UpdateList} from "@/api/δxAdjacent/δxAdjacent";
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        this.$store.dispatch('changeδxAdjacentTime',StartEndTime);
        GetList({
