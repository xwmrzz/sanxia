  ...
  <!--        </el-form-item>-->
      ...
      <el-dialog
        ...
        <el-form :data="formData" :model="editForm" :rules="editFormRules" ref="editForm" label-width="90px"
          ...
          <el-form-item label="高程H(m)" prop="elevationH">
            <el-input v-model="editForm.elevationH" autocomplete="off"></el-input>
          </el-form-item>
...
<script>
  import {GetList, AddList, DeleteList, UpdateList} from "@/api/Elevation/Elevation";
