  ...
  <!--        </el-form-item>-->
      ...
      <el-dialog
        ...
        <el-form :data="formData" :model="editForm" :rules="editFormRules" ref="editForm" label-width="90px"
          ...
          <el-form-item label="与首轮比较垂直位移量(mm)" prop="first_vertical_displacement">
      ...
      <el-dialog  width="80%" :visible.sync="curveWindow">
        <FirstVerticalChart :key="chartKey"></FirstVerticalChart>
      </el-dialog>
    </div>
</template>

<script>
  import FirstVerticalChart from "@/components/FirstVertical/FirstVerticalChart";
  import {GetList, AddList, DeleteList, UpdateList} from "@/api/FirstVertical/FirstVertical";
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        this.$store.dispatch('changeFirstVerticalTime',StartEndTime);
        GetList({
