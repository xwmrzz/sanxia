...
const baseURL = 'http://120.26.61.220:8083'
const requestTimeout = 60000
const contentType =
  'application/x-www-form-urlencoded;charset=UTF-8' // application/json;charset=UTF-8 或 application/x-www-form-urlencoded;charset=UTF-8
