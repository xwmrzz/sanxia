<template>
  <div class="login-container">
    <div class="background">
      <vue-particles color="random" :particleOpacity="0.7" :particlesNumber="100" shapeType="polygon" :particleSize="4"
        linesColor="#e6e6e6" :linesWidth="1" :lineLinked="false" :lineOpacity="0.4" :linesDistance="150" :moveSpeed="3"
        :hoverEffect="true" hoverMode="grab" :clickEffect="true" clickMode="repulse" />
    </div>
    <h1 class="h1">三峡库区预警系统</h1>
    <div class="login">
      <div>
